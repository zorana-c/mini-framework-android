 ...
 * @Description :
 */
public class DetailFragment extends UIListFragment<String> {
    @Override
    ...
    public View onCreateItemView(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent, int itemViewType) {
        return inflater.inflate(R.layout.item_commodity_layout, parent, false);
    }
    ...
    public void onUICreated(@Nullable Bundle savedInstanceState) {
        ...
        final WebView webView = this.requireViewById(R.id.webView);
