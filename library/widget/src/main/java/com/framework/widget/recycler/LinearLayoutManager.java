...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements
    ...
    /**
     * Whether unrestricted sliding is allowed.
     */
    private boolean mLoopScrollEnabled = false;
     ...
     */
    public LinearLayoutManager(@NonNull Context context, @RecyclerView.Orientation int orientation, boolean reverseLayout) {
     ...
     */
    public LinearLayoutManager(@NonNull Context context, @Nullable AttributeSet attrs) {
     ...
     * {@link androidx.recyclerview.R.attr#stackFromEnd}
     */
    public LinearLayoutManager(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * {@link androidx.recyclerview.R.attr#stackFromEnd}
     */
    public LinearLayoutManager(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setLoopScrollEnabled(boolean enabled) {
        ...
        if (mLoopScrollEnabled == enabled) {
            return;
        }
        mLoopScrollEnabled = enabled;
        requestLayout();
    }
    ...
    @NonNull
    public final OrientationHelper requireOrientationHelper() {
        final OrientationHelper helper = this.getOrientationHelper();
        if (helper == null) {
            throw new NullPointerException("Not orientation set.");
        }
        return helper;
    }
    ...
    private void layoutForPredictiveAnimations(RecyclerView.Recycler recycler,
        ...
        for (int i = 0; i < scrapSize; i++) {
            ...
            final RecyclerView.LayoutParams lp =
                    (RecyclerView.LayoutParams) scrap.itemView.getLayoutParams();
            if (lp.isItemRemoved()) {
                continue;
            }
    ...
    private void updateLayoutStateToFillEnd(int itemPosition, int offset) {
        ...
        this.updateCurrentPosition(mLayoutState);
    }
    ...
    private int computeScrollOffset(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return ViewScrollbarHelper.computeScrollOffset(state, mOrientationHelper,
    ...
    private int computeScrollExtent(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return ViewScrollbarHelper.computeScrollExtent(state, mOrientationHelper,
                findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true),
                findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true),
    ...
    private int computeScrollRange(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return ViewScrollbarHelper.computeScrollRange(state, mOrientationHelper,
                findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true),
                findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true),
                this, mSmoothScrollbarEnabled);
    }
    ...
    int fill(RecyclerView.Recycler recycler, LayoutState layoutState,
        ...
        this.onPopulateCompleted(recycler, state);
        if (DEBUG) {
            validateChildOrder();
        }
    ...
    public void onPopulateCompleted(RecyclerView.Recycler recycler,
                                    RecyclerView.State state) {
    }
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        updateCurrentPosition(layoutState);
        if (view == null) {
     ...
     */
    @Nullable
    protected View getChildClosestToStart() {
     ...
     */
    @Nullable
    protected View getChildClosestToEnd() {
