...
/**
 * @Author create by Zoran on 2021/2/16
...
class ViewBoundsCheck {
    ...
    ViewBoundsCheck(ViewBoundsCheck.Callback callback) {
        mCallback = callback;
        mBoundFlags = new ViewBoundsCheck.BoundFlags();
    }
    ...
    static class BoundFlags {
        ...
        void addFlags(@ViewBoundsCheck.ViewBounds int flags) {
            mBoundFlags |= flags;
        }
    ...
    View findOneViewWithinBoundFlags(int fromIndex, int toIndex,
                                     @ViewBoundsCheck.ViewBounds int preferredBoundFlags,
                                     @ViewBoundsCheck.ViewBounds int acceptableBoundFlags) {
     ...
     */
    boolean isViewWithinBoundFlags(View child, @ViewBoundsCheck.ViewBounds int boundsFlags) {
