 ...
 * @Description :
 */
public class SpanLinearLayoutManager extends LinearLayoutManager
        implements RecyclerView.OnChildAttachStateChangeListener {
    private float itemSpanRatio;

    public SpanLinearLayoutManager(@NonNull Context context) {
        this(context, RecyclerView.VERTICAL);
    }

    public SpanLinearLayoutManager(@NonNull Context context, int orientation) {
        this(context, orientation, false);
    }

    public SpanLinearLayoutManager(@NonNull Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
        this.init(context, null);
    }

    public SpanLinearLayoutManager(@NonNull Context context, @NonNull AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpanLinearLayoutManager(@NonNull Context context, @NonNull AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public SpanLinearLayoutManager(@NonNull Context context, @NonNull AttributeSet attrs, int defStyleAttr, int defStyleRes) {
